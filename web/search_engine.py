...
class SearchEngine:
    ...
    def __init__(self, config_path, config_encoding):
        ...
        f = open(config.get('option', 'stop_words_path'), encoding=config.get('option', 'stop_words_encoding'))
        words = f.read()
        self.stop_words = set(words.split('\n'))
        self.conn = sqlite3.connect(config.get('option', 'db_path'))
        self.K1 = config.getfloat('option', 'k1')
        self.B = config.getfloat('option', 'b')
        self.N = config.getint('option', 'n')
        self.AVG_L = config.getfloat('option', 'avg_l')
        self.HOT_K1 = config.getfloat('option', 'hot_k1')
        self.HOT_K2 = config.getfloat('option', 'hot_k2')
