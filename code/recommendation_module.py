...
class RecommendationModule:
    ...
    def __init__(self, config_path, config_encoding):
        ...
        self.doc_dir_path = config['option']['doc_dir_path']
        self.doc_encoding = config['option']['doc_encoding']
        self.stop_words_path = config['option']['stop_words_path']
        self.stop_words_encoding = config['option']['stop_words_encoding']
        self.idf_path = config['option']['idf_path']
        self.db_path = config['option']['db_path']
